...
if __name__ == '__main__':
    ...
    # set time scale
    time_scale = '4h'  # Get the timescale from command line arguments
    ...
    webhook_kk_quant_discord_powaysha = 'https://discord.com/api/webhooks/1187708183368712292/SwWzVhBX1rsn_GxjRdM3YdllQq9hXO55OzoxnKAizAyyfb70nNXGZ5NyrupLu8i60nlz'
