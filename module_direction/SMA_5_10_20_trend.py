...
def main(pd_OHLC_high, run_mode = 'live', num_candles=30, num_consecutive_candel=2):
    ...
    if run_mode == 'live':
        ...
        # Check SMA conditions
        if all(pd_OHLC_high['5_SMA'] > pd_OHLC_high['10_SMA']) \
                and all(pd_OHLC_high['10_SMA'] > pd_OHLC_high['20_SMA']):
            return 1
        elif all(pd_OHLC_high['5_SMA'] < pd_OHLC_high['10_SMA']) \
                and all(pd_OHLC_high['10_SMA'] < pd_OHLC_high['20_SMA']):
            return -1
        else:
            return 0
